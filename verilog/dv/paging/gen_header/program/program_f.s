...
word_loop1:     beq a1,  zero, done1
                lw  t1, 0(a0)               #load next word
                xor t0, t0, t1              #fold it into the low byte of crc
                addi t2, zero, 32           #32 bits per word
...
no_xor1:        addi t2, t2, -1             #decrement bit counter
                ...
                addi a0, a0, 4              #increment data pointer by one byte
                addi a1, a1, -4             #decrement data length
                jal zero, word_loop1
...
main2:          jalr ra, s5, 0x0            #function call of req_next at addr s5
                ...
                nop
                nop
crc32b_acc:     lui a0, 0xdeadc
                addi a0, a0, -273           #a0=0xdeadbeef
                jalr zero, ra, 0
